...
Brewer.PesquisaRapidaCliente = (function() {
	...
	function PesquisaRapidaCliente() {
		...
		this.mostrarPesquisaRapidaModalBtn = $('#pesquisaRapidaClientesSearchBtn'); 
	}
	
	PesquisaRapidaCliente.prototype.iniciar = function() {
		this.pesquisaRapidaBtn.on('click', onPesquisaRapidaClicado.bind(this));
		this.mostrarPesquisaRapidaModalBtn.on('click', onPesquisaClienteClicado.bind(this));
	...
	function onPesquisaClienteClicado(event) {
		event.preventDefault();
		this.nomeInput.val('');
